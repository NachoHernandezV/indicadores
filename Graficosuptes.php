...
//	
        ...
        {   
			...
			$Valores2[$j+1]=$row2['creditos'];
			$Valores2[$j+3]=$row2['garantias'];
			$Valores2[$j+4]=$row2['cadenas'];
		...
		$porcreditos=round(($Valores[1]/$total)*100,1);
...
// Position the four pies and change color
	...
	//TRIGOS CAMBIO ANTES ERA TRENES
	$nombres=array("Proveedores $porproveedores%%","Creditos $porcreditos%%","Trigos $portrenes%%","Garantias $porgarantias%%","Cadenas $porcadenas%%"); 
	...
	//$nombres=array("$$Valores2[0]","$$Valores2[2]","$$Valores2[1]","$$Valores2[3]","$$Valores2[4]"); 
...
// Position the four pies and change color
	...
	$nombres=array("Proveedores","Cadenas","Trenes","Garantias","Creditos"); 
	$p->SetLegends($nombres); 
