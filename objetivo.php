...
elseif($nomtabla['nombreind'] == "Numero de Servicios")
{
	$tabla="sis2_numserv";
}
elseif($nomtabla['nombreind'] == "Horas perdidas de red")
{
	$tabla="sis3_horaslost";
}
elseif($nomtabla['nombreind'] == "Desarrollo de software")
{
	$tabla="sis4_desarrollo";
}
...
{
	echo '<option value="'.$row2['objetivo'].'">'.$row2['objetivo'].'</option>';
}
?>
