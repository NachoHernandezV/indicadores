...
<div align ="center">
	<table>
		...
		<tr>
			<td>
			<FORM ACTION=excelreporteimp.php METHOD=post name="gra" id="gra">
		...
		<tr>
			<td>
			<form action=pdfreporteimp.php method="POST" target="ventanit" onsubmit="ventanit=window.open('','ventanit','width=900,height=600′)">
