...
///para Enviar a el Archivo de Reportes
	...
	$year3=$_SESSION['anioget'];
	$period=$_SESSION['periodoget'];

	$query2=mysqli_query($link,"Select * from anios where idanio='".$year3."'");
...
///para Enviar a el Archivo de Reportes
	...
	$query2=mysql_query("Select * from anios where idanio='".$year3."'");
...
// Position the four pies and change color
	...
	$nombres=array("Compensaciones","Devoluciones"); 
	$p->SetLegends($nombres); 
