...
require_once 'Classes/PHPExcel.php';
	...
	$excel->getActiveSheet()->getStyle('B4:C4')->getFill()
		...
		$excel->getActiveSheet()->getStyle('B9')->getFill()
        ->applyFromArray(array('type' => PHPExcel_Style_Fill::FILL_SOLID,
        'startcolor' => array('rgb' => 'ABD7AC')
        ));
		
		$excel->getActiveSheet()->getStyle('B13')->getFill()
        ->applyFromArray(array('type' => PHPExcel_Style_Fill::FILL_SOLID,
        'startcolor' => array('rgb' => 'ABD7AC')
        ));
			
		$excel->getActiveSheet()->getStyle('B21')->getFill()
        ->applyFromArray(array('type' => PHPExcel_Style_Fill::FILL_SOLID,
        'startcolor' => array('rgb' => 'ABD7AC')
        ));
			
		$excel->getActiveSheet()->getStyle('B28')->getFill()
        ->applyFromArray(array('type' => PHPExcel_Style_Fill::FILL_SOLID,
        'startcolor' => array('rgb' => 'ABD7AC')
        ));	
		...
		$excel->getActiveSheet()->getStyle('B11')->getFill()
        ->applyFromArray(array('type' => PHPExcel_Style_Fill::FILL_SOLID,
        'startcolor' => array('rgb' => 'F5F5F2')
        ));
		
		$excel->getActiveSheet()->getStyle('B16')->getFill()
        ->applyFromArray(array('type' => PHPExcel_Style_Fill::FILL_SOLID,
        'startcolor' => array('rgb' => 'F5F5F2')
        ));
		
		$excel->getActiveSheet()->getStyle('B24')->getFill()
        ->applyFromArray(array('type' => PHPExcel_Style_Fill::FILL_SOLID,
        'startcolor' => array('rgb' => 'F5F5F2')
        ));
		
		$excel->getActiveSheet()->getStyle('B29')->getFill()
        ->applyFromArray(array('type' => PHPExcel_Style_Fill::FILL_SOLID,
        'startcolor' => array('rgb' => 'F5F5F2')
        ));
...
{		
	...
	$limite=$mayor-1;
	$excel->getActiveSheet()
			  ->getStyle("B3:$letra[$limite]29") // A D
			  ->applyFromArray($borders);
	while ($mayor != 0)
	{
		$borders = array
