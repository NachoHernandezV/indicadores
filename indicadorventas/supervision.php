...
<td>
	<input type="image" src="antiguos1.jpg" value="antecedente" width="80" height="35" onclick="window.open('buscartesoreriaant.php','nuevaVentana2','width=500, height=650')" />
</td>
...
<td>
	<input type="image" src="antiguos1.jpg" value="antecedente" width="80" height="35" onclick="window.open('buscaranteceimp.php','nuevaVentana','width=500, height=600')" />
</td>	
...
<td>
	<input type="image" src="antiguos1.jpg" value="antecedente" width="80" height="35" onclick="window.open('buscarantecendentes.php','nuevaVentana','width=500, height=700')" />
</td>
