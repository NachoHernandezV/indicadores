...
$link=mysqli_connect($server,$user,$pass,$bd);
	...
	$sqlani="SELECT count(*) FROM a1_rot WHERE year1='".$yearactual."'";
	...
	{
		$lmes="SELECT idmes FROM a1_rot where year1=".$yearanterior." ORDER BY idmes DESC LIMIT 1";
	}
	else
	{
		$lmes="SELECT idmes FROM a1_rot where year1=".$yearactual." ORDER BY idmes DESC LIMIT 1";
	}
	

	
		
	//$lmes="SELECT idmes FROM a1_rot where year1=".date("Y")." ORDER BY idmes DESC LIMIT 1";
